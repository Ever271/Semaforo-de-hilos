...
public class ControladorCruce {
    ...
    synchronized (controlTurnos) {
        ...
        // Reiniciamos el contador únicamente de la calle
        // que comienza su nuevo turno.
    ...
    synchronized (lista) {
        ...
        /*
         * 1. El primer carro cruza y sale completamente.
         */
        moverAutoVisual(autoVisual, calle, destino);

        /*
         * 2. Sacamos el carro que pasó del modelo.
         */
        Auto autoQuePaso = lista.remove(0);

        /*
         * 3. Rotamos inmediatamente el arreglo visual.
         */
        ...
        /*
         * 4. Los dos carros restantes avanzan.
         */
        avanzarDosCarros(
            autosVisuales[0],
            autosVisuales[1],
        ...
        /*
         * 5. El carro que pasó aparece DETRÁS del último.
         */
        colocarAlFinal(
            autosVisuales[2],
            autosVisuales[1],
        ...
        /*
         * 6. El auto vuelve al final del modelo.
         */
...
private void colocarAlFinal(
    ...
    switch (calle) {
        ...
        case Auto.CALLE_SUR:
            ...
            // Empieza abajo, fuera de la pantalla
            autoQuePaso.setLocation(
                destinoX,
                vista.getHeight()
            );
        ...
        case Auto.CALLE_ESTE:
            ...
            // Empieza a la derecha, fuera de la pantalla
            autoQuePaso.setLocation(
                vista.getWidth(),
                destinoY
            );
        ...
        case Auto.CALLE_OESTE:
            ...
            // Empieza a la izquierda, fuera de la pantalla
            autoQuePaso.setLocation(
    ...
    // CAMBIAMOS IMAGEN Y TAMAÑO EN EL GIRO
    switch (calle) {

    // NORTE viene bajando y gira hacia la izquierda.
    // Para mirar a la IZQUIERDA usamos la imagen ESTE.
    case Auto.CALLE_NORTE:
        cambiarOrientacion(
            autoVisual,
            VAuto.ESTE,
    ...
    // SUR viene subiendo y gira hacia la derecha.
    // Para mirar a la DERECHA usamos la imagen OESTE.
    case Auto.CALLE_SUR:
        cambiarOrientacion(
            autoVisual,
            VAuto.OESTE,
    ...
    // ESTE viene desde la derecha y gira hacia arriba.
    // Para mirar ARRIBA usamos la imagen SUR.
    case Auto.CALLE_ESTE:
        cambiarOrientacion(
            autoVisual,
            VAuto.SUR,
    ...
    // OESTE viene desde la izquierda y gira hacia abajo.
    // Para mirar ABAJO usamos la imagen NORTE.
    case Auto.CALLE_OESTE:
        cambiarOrientacion(
            autoVisual,
            VAuto.NORTE,
...
private void cambiarOrientacion(
    ...
    private void avanzarFilaVisual(int calle) {

    VAuto[] autos = getAutosVista(calle);

    if (autos == null || autos.length < 3) {
        return;
    }

    // Guardamos las posiciones ANTES de mover cualquier carro
    int xPrimero = autos[0].getX();
    int yPrimero = autos[0].getY();

    int xSegundo = autos[1].getX();
    int ySegundo = autos[1].getY();

    // Segundo ocupa la posición original del primero
    moverSuave(
        autos[1],
        xPrimero,
        yPrimero
    ...
    // Tercero ocupa la posición original del segundo
    moverSuave(
        autos[2],
        xSegundo,
        ySegundo
    ...
    private void acomodarFilaVisual(int calle) {
    ...
    VAuto autoQuePaso = autos[0];

    // Rotamos el arreglo visual
    autos[0] = autos[1];
    autos[1] = autos[2];
    autos[2] = autoQuePaso;

    // El carro que pasó aparece al final de la fila
    switch (calle) {
